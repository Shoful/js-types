 ...
 */
let newarray = [q11.length];
for (let i = 0; i < q11.length; i++) {
  newarray[i] = q11[i].length;
}
const q12 = newarray;
 ...
 */
let words = newarray.length
let value = newarray.reduce((total, amount) => total + amount);
let calculation = value / words;
const q13 = calculation;
